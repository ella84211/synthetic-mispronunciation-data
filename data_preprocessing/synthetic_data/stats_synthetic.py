...
input_file = "synthetic_data/data/synthetic_transcriptions_set1.json"
...
with open("syn_output.json", "w", encoding="utf-8") as file:
...
with open("syn_output2.tsv", "w", encoding="utf-8") as file:
...
with open("syn_output1.tsv", "w", encoding="utf-8") as file:
...
df = pd.read_csv("synthetic_phoneme_annotations_all.csv")
